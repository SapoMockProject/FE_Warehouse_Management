  ...
  const handleSave = async () => {
    try {
      ...
      for (let i = 0; i < variantsFormData.length; i++) {
        formData.append(
          `variants[${i}].stock`,
          variantsFormData[i].stock.toString()
        );
        formData.append(
          `variants[${i}].price`,
          variantsFormData[i].price.toString()
        );
        formData.append(`variants[${i}].sku`, variantsFormData[i].sku);
        formData.append(
          `variants[${i}].option1value`,
          variantsFormData[i].option1value
        );
        formData.append(
          `variants[${i}].option2value`,
          variantsFormData[i].option2value
        );
        formData.append(
          `variants[${i}].option3value`,
          variantsFormData[i].option3value
        );
      }
