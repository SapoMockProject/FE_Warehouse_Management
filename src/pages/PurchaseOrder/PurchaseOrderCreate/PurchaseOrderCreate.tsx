...
import type { ProductResponse, ProductVariantItem } from "../../../types/IProduct";
...
const PurchaseOrderCreate: React.FC = () => {
	...
	const convertToProductVariants = (products: ProductResponse[]): ProductVariantItem[] => {
								...
								{isOpenSearchProduct && (
									<div className="purchase-order-dropdown">
										...
										<div className="purchase-order-dropdown-item">
											...
											>
												{loadingProduct ? "" : hasMoreProduct ? "Cuộn để tải thêm" : ""}
											</div>
										</div>
									</div>
								)}
												...
												<td>
													<div className="purchase-order-product-info">
														...
														<div className="purchase-order-product-text">
															<div className="purchase-order-product-name">{item.name}</div>
