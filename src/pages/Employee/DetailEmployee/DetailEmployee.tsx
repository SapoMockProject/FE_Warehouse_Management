		...
		<>
			<div className="employee-detail-container">
				<div className="employee-detail-wrapper">
					<div className="employee-detail-image-wrapper">
						<span className="employee-detail-title">Thông tin tài khoản</span>
						<img src={employeeInfo?.avatar} alt={employeeInfo?.fullName} />
					</div>
					<div className="employee-detail-info-wrapper">
						<div className="employee-detail-input-wrapper">
							<InputEmployeeInfo onChange={(value) => handleInputChange("fullName", value)} type="text" label="Họ và tên" value={employeeInfo?.fullName} />
							<InputEmployeeInfo onChange={(value) => handleInputChange("email", value)} type="text" label="Email" value={employeeInfo?.email} />
						</div>
						<div className="employee-detail-input-wrapper">
							<InputEmployeeInfo onChange={(value) => handleInputChange("phoneNumber", value)} type="text" label="Số điện thoại" value={employeeInfo?.phoneNumber} />
