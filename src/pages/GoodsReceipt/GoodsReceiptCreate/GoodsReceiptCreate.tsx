...
const GoodsReceiptCreate: React.FC = () => {
  ...
  const [goodsReceiptRequest, setGoodsReceiptRequest] =
    useState<GoodsReceiptRequest>(bodyRequest);

  const [orderItems, setOrderItems] = useState<ProductVariantItem[]>([]);
  const [loading, setLoading] = useState(false);

  const [inputValue, setInputValue] = useState<string>("");
  const [isOpenSearchVariant, setIsOpenSearchVariant] =
    useState<boolean>(false);
  const [searchProductVariants, setSearchProductVariants] = useState<
    ProductVariantItem[]
  >([]);
  ...
  const [selectedVariantFixPrice, setSelectedVariantFixPrice] =
  ...
  useEffect(() => {
    if (purchaseOrderData) {
      ...
      const requestItems: GoodsReceiptItemRequest[] =
        purchaseOrderData.items.map((item: PurchaseOrderItemResponse) => ({
      ...
      setGoodsReceiptRequest({
        ...
        assignedToAccountId:
          purchaseOrderData.infoEmployeeIsAssigned?.id || null,
        receiptDate: "",
  ...
  const handleSelectVariant = (productVariantId: number) => {
    const variant = searchProductVariants.find(
      (p) => p.id === productVariantId
    );

    if (variant && !orderItems.find((item) => item.id === productVariantId)) {
      setOrderItems((prev) => [...prev, { ...variant, quantityPurchase: 1 }]);
  ...
  const updateQuantity = (variantId: number, quantity: number | string) => {
    ...
    setOrderItems(
      orderItems.map((item) =>
        item.id === variantId ? { ...item, quantityPurchase: qty } : item
      )
    );
  ...
  const handleSubmitGoodsReceipt = async () => {
    ...
    if (goodsReceiptRequest.transactionInfo) {
      ...
      if (
        !goodsReceiptRequest.transactionInfo.amount ||
      ...
      if (
        ...
        error.paymentAmount =
          "Số tiền thanh toán không được lớn hơn tổng tiền nhập";
      }
    ...
    const accountId = goodsReceiptRequest.assignedToAccountId
      ? goodsReceiptRequest.assignedToAccountId
      : user?.user.id;
      ...
      <div className="purchase-order-container">
        <div className="purchase-order-left-panel">
          <div className="purchase-order-section">
            ...
            {error.goodsReceiptItem && (
              <ValidationMessage
                show={true}
                message={error.goodsReceiptItem}
                type="error"
              />
            )}
            ...
            <div className="purchase-order-payment-summary">
              <div className="purchase-order-payment-row">
                ...
                <span className="purchase-order-payment-currency">
                  {goodsReceiptRequest.totalLineItemsPriceAfterDiscount.toLocaleString(
                    "vi-VN"
                  )}
                  đ
                </span>
              ...
              <div className="purchase-order-payment-row">
                ...
                <span className="purchase-order-payment-currency">
                  {goodsReceiptRequest.discountValue != null
                    ? goodsReceiptRequest.discountValue.toLocaleString("vi-VN")
                    : 0}
                  đ
                </span>
              </div>
              ...
              {!showPaymentForm ? (
                <div className="payment-later-notice">
                  ...
                  <div>
                    ...
                    <p>
                      Phiếu nhập hàng sẽ được ghi nhận với trạng thái chưa thanh
                      toán
                    </p>
                  </div>
                </div>
                ...
                <div className="payment-details-form">
                  <div className="purchase-order-form-group">
                    ...
                    <CustomSelect
                      ...
                      value={
                        goodsReceiptRequest.transactionInfo?.paymentMethodId?.toString() ||
                        null
                      }
                      onChange={(val) =>
                    ...
                    >
                      <Button
                        ...
                        onClick={() =>
                          handlePaymentFieldChange(
                            "amount",
                            Math.round(goodsReceiptRequest.totalPrice * 0.25)
                          )
                        }
                        variant="tertiary"
                        size="sm"
                      ...
                      <Button
                        ...
                        onClick={() =>
                          handlePaymentFieldChange(
                            "amount",
                            Math.round(goodsReceiptRequest.totalPrice * 0.5)
                          )
                        }
                        variant="tertiary"
                        size="sm"
                      ...
                      <Button
                        ...
                        onClick={() =>
                          handlePaymentFieldChange(
                            "amount",
                            Math.round(goodsReceiptRequest.totalPrice * 0.75)
                          )
                        }
                        variant="tertiary"
                        size="sm"
                  ...
                  <div className="purchase-order-form-group">
                    <DateField
                      ...
                      value={
                        goodsReceiptRequest.transactionInfo?.processedOn || ""
                      }
                      onChange={(val) =>
                  ...
                  <div className="purchase-order-form-group">
                    <Input
                      ...
                      label="Mã tham chiếu"
                      value={
                        goodsReceiptRequest.transactionInfo?.referenceCode || ""
                      }
                      onChange={(val) =>
                  ...
                  <div className="payment-summary-box">
                    <div className="payment-summary-row">
                      ...
                      <strong>
                        {goodsReceiptRequest.totalPrice.toLocaleString("vi-VN")}
                        đ
                      </strong>
                    </div>
                    <div className="payment-summary-row">
        ...
        <div className="purchase-order-right-panel">
            ...
            <div className="purchase-order-section">
              ...
              >
                ...
                <div style={{ fontSize: "14px", color: "#666" }}>
                  ...
                  {formatDateTime(purchaseOrderData.createdDate)}
                </div>
              </div>
            </div>
          )}
          ...
          <div className="purchase-order-section">
            ...
            <div className="purchase-order-form-group">
              ...
              <CustomSelect
                ...
                value={
                  goodsReceiptRequest.assignedToAccountId
                    ? goodsReceiptRequest.assignedToAccountId.toString()
                    : null
                }
                onChange={(val) =>
            ...
            <div className="purchase-order-form-group">
              <DateField
                ...
                onChange={(val) =>
                  handleChangeGoodsReceiptField("receiptDate", val as string)
                }
            ...
            <div className="purchase-order-form-group">
              <Input
                ...
                onChange={(val) =>
                  handleChangeGoodsReceiptField("refference", val as string)
                }
          ...
          <div className="purchase-order-section">
            <Input
              ...
              onChange={(val) =>
                handleChangeGoodsReceiptField("description", val as string)
              }
