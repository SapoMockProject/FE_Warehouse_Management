		...
		<div className={`sidebar ${isCollapsed ? "collapsed" : ""}`}>
				...
				<button className="sidebar-collapse-btn" onClick={toggleSidebar}>
					...
					>
						...
						<g id="SVGRepo_iconCarrier">
							{" "}
							<title>arrow_left [#335]</title> <desc>Created with Sketch.</desc> <defs> </defs>{" "}
							<g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
								{" "}
								<g id="Dribbble-Light-Preview" transform="translate(-345.000000, -6679.000000)" fill="#9e9e9e">
									{" "}
			...
			<div className="sidebar-menu">
				<nav className="sidebar-nav">
					...
					<NavLink to="/goods-receipts" className="sidebar-link" title="Goods Receipt">
						<div className="menu-icon">
							<svg
								className="icon"
								xmlns="http://www.w3.org/2000/svg"
							...
							>
								<g fill="none" stroke="#ffffff">
									<path d="M3 7c0-1.886 0-2.828.586-3.414C4.172 3 5.114 3 7 3h10c1.886 0 2.828 0 3.414.586C21 4.172 21 5.114 21 7v10c0 1.886 0 2.828-.586 3.414C19.828 21 18.886 21 17 21H7c-1.886 0-2.828 0-3.414-.586C3 19.828 3 18.886 3 17z" />
									<path d="M3 12c0 .932 0 1.398.152 1.765a2 2 0 0 0 1.083 1.083C4.602 15 5.068 15 6 15h.675c.581 0 .872 0 1.104.134a.995.995 0 0 1 .164.118c.2.178.292.453.476 1.005l.125.375c.22.66.33.99.592 1.18c.262.188.61.188 1.306.188h3.117c.695 0 1.043 0 1.305-.189s.372-.518.592-1.178l.125-.376c.184-.552.276-.827.476-1.005a.99.99 0 0 1 .164-.118c.232-.134.523-.134 1.104-.134H18c.932 0 1.398 0 1.765-.152a2 2 0 0 0 1.083-1.083C21 13.398 21 12.932 21 12M9.5 10.5L12 13m0 0l2.5-2.5M12 13V6" />
								</g>
							</svg>
						</div>
						...
						<NavLink to="/employees" className="sidebar-link" title="Employee">
							<div className="menu-icon">
								<svg
									...
									fill="#ffffff"
								>
									<g id="clarityEmployeeLine0" fill="#ffffff">
										<path d="M16.43 16.69a7 7 0 1 1 7-7a7 7 0 0 1-7 7Zm0-11.92a5 5 0 1 0 5 5a5 5 0 0 0-5-5ZM22 17.9a25.41 25.41 0 0 0-16.12 1.67a4.06 4.06 0 0 0-2.31 3.68v5.95a1 1 0 1 0 2 0v-5.95a2 2 0 0 1 1.16-1.86a22.91 22.91 0 0 1 9.7-2.11a23.58 23.58 0 0 1 5.57.66Zm.14 9.51h6.14v1.4h-6.14z" />
